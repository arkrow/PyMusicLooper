...
class MusicLooper:
    ...
    def find_loop_pairs(self, method='corr', min_duration_multiplier=0.2, use_plp=False, keep_at_most=10):
        ...
        S_weighed = librosa.core.perceptual_weighting(S, librosa.fft_frequencies(sr=self.rate))
